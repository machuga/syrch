...
export const createBinaryExpression = (left : Expression, right : Expression, operator : LogicalAndOperator | LogicalOrOperator) : BinaryExpression => ({
...
export const createBinaryRange = (left : RangeLeftTerm, right: RangeRightTerm, field : string = implicit) : BinaryRange => ({
